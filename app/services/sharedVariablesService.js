cultivatedmooseApp.service('sharedVariablesService', function () {
    var shoppingcartitemnumberShr = 0;

    this.setShoppingcartitemnumberShr = function (str) {
        shoppingcartitemnumberShr = str;
    };

    this.getShoppingcartitemnumberShr = function () {
        return shoppingcartitemnumberShr;
    };
